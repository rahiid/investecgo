...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/css/deposit-m.css')}}">
        ...
        <div class="addmoney user-inner" id="scrollbar">
            ...
            <div class="addmoney-text">
                ...
                <p style="text-align: center;">
                    <strong style="color: #3361FF;">INVESTNOW Money Deposit</strong> <br>
                ...
                <div class="addmoney-items" >
                    ...
                    <div class="form-group" >
                        ...
                        <input class="addmoney-control addmoney-items " type="number" step="0.00001" id="ammount" name="ammount" min="10" style="width: 60%;" required>
                        <br>
