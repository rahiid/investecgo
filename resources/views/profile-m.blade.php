...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/css/profilemobile.css')}}">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="user-inner">
                        ...
                        <h5>Name &nbsp;  &nbsp;: &nbsp; {{{ isset(Auth::user()->name) ? Auth::user()->name : Auth::user()->email }}} <button class="user_change_btn" onclick="useredit(1)" type="button">EDIT</button></h5>
                        ...
                        <h5>Email &nbsp;  &nbsp; : &nbsp; {{{ isset(Auth::user()->name) ? Auth::user()->email : Auth::user()->email }}} <button class="user_change_btn" onclick="useredit(2)" type="button">EDIT</button></h5>
                       ...
                       <h5>Phone&nbsp;&nbsp; : &nbsp; 0{{{ isset(Auth::user()->name) ? Auth::user()->phone : Auth::user()->email }}} <button class="user_change_btn" onclick="useredit(3)" type="button">EDIT</button></h5>
                            <form action="change_number" method="POST">
                                @csrf
